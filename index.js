    ...
    Data: new Object({
        ObjFastConfig: {
            ...
            "HTML": {   
                "HTML": true,
                "UserName": "Guest",
                "MusicLink": "https://drive.google.com/uc?id=14bUhv5SpbyauQJZZ5bi-jQst_uZzI8Ea&export=download"
            },
            "AntiGetInfo": {
                ...
                case false: {
                    ...
                    if (!NodeVersion.includes("v14") && !NodeVersion.includes("v16") && !Database(true).has('SkipReplitNix')) {
                        ...
                        try {
                            ...
                            console.log(e);
                            log.error("[ TRA-UPDATE ] •","NodeJS v14 Installation Failed, Please Try Again and Contact fb.com/Lazic.Kanzu!");
                            process.exit(0);
                        }
                    }
                }
